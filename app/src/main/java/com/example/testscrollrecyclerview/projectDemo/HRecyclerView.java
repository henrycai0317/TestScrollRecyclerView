...
import static com.example.testscrollrecyclerview.projectDemo.DensityUtils.dip2px;
    ...
    private View createMoveRecyclerView() {
        ...
        if(null !=mAdapter){
            if (mAdapter instanceof CommonAdapter) {
                ...
                mHeadViewList = ((CommonAdapter) mAdapter).getHeadViewList();
            }
        }
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (mRecyclerView.canScrollVertically(-1)){
                    mShadowVertical.setElevation(20);
                } else  {
                    mShadowVertical.setElevation(0);
                }
            }
        });
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (offsetX > 30) {
                    ...
                    if (0 == mMoveOffsetX) {
                        mLeftTitleLayout.setElevation(0);
                    } else {
                        mLeftTitleLayout.setElevation(20);
                    }

                    if (null != mHeadViewList) {
                        for (int i = 0; i < mHeadViewList.size(); i++) {
                            if (0 == mMoveOffsetX) {
                                mHeadViewList.get(i).setElevation(0);
                            } else {
                                mHeadViewList.get(i).setElevation(20);
                            }
                        }
